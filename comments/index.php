...
<div class='container'>
    <div class='row'>
        ...
        <div class='col-lg-4 col-md-5 col-sm-4 offset-md-1 offset-sm-1 col-12 mt-4'>
            <form id='algin-form' method='POST' action='post_comment.php'>
                ...
                <div class='form-group'> <button type='submut' id='post' name='post_comment' class='btn'>Post Comment</button> </div>
            </form>
        </div>
    </div>
</div>
