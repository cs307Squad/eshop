...
if(isset($_POST['start_create'])){
    ...
    $query = "insert into ManagerTasks(Task_ID, User_ID, Tasks, Due, title, description) values ('$task_id', '$user', '$tasks', '$due','$title','$description')";
